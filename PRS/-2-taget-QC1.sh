...
## cd /mnt/c/Users/Ming/Documents/GitHub/liaoming/PRS #from liaoming's dell
## cd /Users/maoyan/Documents/GitHub/liaoming/PRS    #from liaoming'smac-book Pro
data_field="ukb22418"
...
# write-snplist ：nforms plink to only generate the QC'ed SNP list to avoid generating the .bed file.